...
open class GrowingTextView: UIView {
    ...
    //gif edit
    open var onPasteCalledForMedia: (()->Void)?
    //gif edit
    ...
    fileprivate var textView: GrowingInternalTextView = {
        ...
        textView.iq.resignOnTouchOutsideMode = .disabled 
        return textView
    }()
...
extension GrowingTextView {
    fileprivate func commonInit() {
        ...
        addSubview(textView)
        //gif edit
        textView.onPasteImage = onPasteCalledForMedia
        //gif edit
    }
    
    //gif edit
    public func mediaPastListner(onTriggred: @escaping () -> Void){
        textView.onPasteImage = onTriggred
    }
    //gif edit
    ...
    public func updateScrollPosition(animated: Bool) {
