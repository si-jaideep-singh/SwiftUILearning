...
class CometChatSharedMediaItem: UICollectionViewCell {
    ...
    @IBOutlet weak var photo: SDAnimatedImageView!
...
//                        }
//                    }
                    let placeHolderImage = UIImage(named: "default-image.png", in: UIKitSettings.bundle, compatibleWith: nil)
                    self.photo.sd_setImage(with: url, placeholderImage: placeHolderImage, context: nil)
                }
            case .video:
