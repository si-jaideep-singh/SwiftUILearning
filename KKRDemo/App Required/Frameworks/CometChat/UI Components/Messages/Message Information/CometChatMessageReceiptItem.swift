...
class CometChatMessageReceiptItem: UITableViewCell {

    @IBOutlet weak var avtar: CometChatAvatar!
    ...
    func setFontForKKR() {
        ...
        deliveredAt.font = .customFont(customFont: .rubikRegular, size: 10)
        readAt.font = .customFont(customFont: .rubikRegular, size: 10)
    }
