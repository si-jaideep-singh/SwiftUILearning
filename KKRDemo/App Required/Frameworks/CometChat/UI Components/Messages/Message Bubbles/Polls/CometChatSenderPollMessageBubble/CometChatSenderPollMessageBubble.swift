//
//  CometChatSenderPollMessageBubble.swift
//  CometChatSwift
//
...
class CometChatSenderPollMessageBubble: UITableViewCell {
    ...
    var pollMessage: CustomMessage! {
        didSet{
            DispatchQueue.main.async {
                self.pinMessageView.isHidden = !(self.pollMessage?.isPinned ?? false)
            }
    ...
    func setFontForKKR() {
        question.font = .customFont(customFont: .rubikRegular, size: 16)
        option1Text.font = .customFont(customFont: .rubikRegular, size: 14)
        option2Text.font = .customFont(customFont: .rubikRegular, size: 14)
        option3Text.font = .customFont(customFont: .rubikRegular, size: 14)
        option4Text.font = .customFont(customFont: .rubikRegular, size: 14)
        option5Text.font = .customFont(customFont: .rubikRegular, size: 14)
    }
