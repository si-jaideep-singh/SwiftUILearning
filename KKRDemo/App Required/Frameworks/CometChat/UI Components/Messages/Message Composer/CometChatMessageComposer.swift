...
// MARK: - Declaration of Protocol
  ...
  protocol CometChatMessageComposerInternalDelegate: AnyObject {
    ...
    func didGifyButtonPressed()
}

/*  ----------------------------------------------------------------------------------------- */

@IBDesignable open class CometChatMessageComposer:UIView
{
    
      // MARK: - Declaration of Variables
    
    var view:UIView!
    weak var internalDelegate: CometChatMessageComposerInternalDelegate?
    ...
    func loadViewFromNib() {
        ...
        let nib = UINib(nibName: "CometChatMessageComposer", bundle: bundle)
    ...
    @IBAction func gifyButtonPressed(_ sender: Any) {
        internalDelegate?.didGifyButtonPressed()
    }
